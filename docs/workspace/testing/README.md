...
- Only create real test handoffs when a real environment, cold start, rescan, Dashboard observation, runtime monitor, or cross-repository integration proof is required.
